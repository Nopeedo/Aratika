...
export interface DefiningBill {
  ...
  featured?: {
    ...
    /* `stats` (hand-written headline figures) was removed: the bill's sources
       are page-level links that evidence none of them directly. Re-add it with
       a citation per figure, not before. */
  }
}

 ...
 * highlighting the current stage. Shared by the reader, the bill-detail page,
 * and the editor preview. Jade theme: completed = green, current = amber,
 * upcoming = grey. Degrades gracefully when the stage isn't known yet.
 */

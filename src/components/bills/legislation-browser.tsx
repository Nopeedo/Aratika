    ...
    return (
      <div style={{ textAlign: 'center', padding: '60px 0', maxWidth: 520, margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 15, color: MUTED, fontFamily: MANROPE, lineHeight: 1.6, margin: 0 }}>
          We pull bills daily from the official register and draft a plain-language breakdown of each. They appear here once an Politika editor has reviewed them for accuracy and neutrality. Check back shortly.
        </p>
      </div>
    )
  }

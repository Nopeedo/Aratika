...
/**
 * CompanionWidget — "Ask Politika". A floating chat helper (bottom-right) that
 * answers questions grounded in Politika's own data, knows which page you're on,
...
export function CompanionWidget() {
  ...
  return (
    <div style={{ position: 'fixed', right: 20, bottom: 20, zIndex: 65, fontFamily: MANROPE }}>
          ...
          >
            ...
            <div style={{ background: 'linear-gradient(150deg,#0f9152,#0c0e12)', padding: '14px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
                ...
                <div>
                  <div style={{ fontSize: 14.5, fontWeight: 800, color: '#fff' }}>Ask Politika</div>
              ...
              <>
                ...
                <div style={{ borderTop: `1px solid ${BORDER}`, padding: '10px 12px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 7 }}>
                    <span style={{ fontSize: 10.5, color: TERTIARY, display: 'inline-flex', alignItems: 'center', gap: 4 }}><ShieldCheck style={{ width: 11, height: 11, color: JADE }} /> Sourced from Politika · can make mistakes, so check the sources</span>
      ...
      {/* FAB */}
      <button onClick={() => setOpen((o) => !o)} aria-label="Ask Politika" style={{ display: 'flex', alignItems: 'center', gap: 9, cursor: 'pointer', background: JADE, color: '#fff', border: 'none', borderRadius: 999, padding: '11px 18px 11px 13px', boxShadow: '0 8px 24px rgba(31,138,76,.4)' }}>
        <Sparkles style={{ width: 19, height: 19 }} />
        <span style={{ fontSize: 14, fontWeight: 800 }}>Ask Politika</span>
      </button>
    </div>
  )
}

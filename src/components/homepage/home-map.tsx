...
export function HomeMap() {
  ...
  return (
    <section id="map" className="bg-dot-grid" style={{ backgroundColor: '#ffffff', borderTop: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}`, scrollMarginTop: 210 }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '52px clamp(18px, 5vw, 36px) 6px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 12, flexWrap: 'wrap' }}>
          <div>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, fontSize: 14, fontWeight: 800, letterSpacing: '.1em', textTransform: 'uppercase', color: JADE, fontFamily: MANROPE, marginBottom: 10 }}>

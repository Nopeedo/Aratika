    ...
    <section style={{ background: '#0c0e12' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '44px clamp(18px, 5vw, 36px) 40px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 16, flexWrap: 'wrap', marginBottom: 20 }}>
          <div>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, fontSize: 14, fontWeight: 800, letterSpacing: '.1em', textTransform: 'uppercase', color: '#36e08a', fontFamily: MANROPE, marginBottom: 8 }}>
              <Vote style={{ width: 15, height: 15 }} /> 2026 Election Centre
            </div>
            <h2 style={{ fontSize: 'clamp(28px,4.5vw,37px)', fontWeight: 800, letterSpacing: '-.02em', color: '#fff', fontFamily: MANROPE, margin: 0, lineHeight: 1.15 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 260px), 1fr))', gap: 12, marginBottom: 20 }}>
          ...
          <Link href="/elections/2026#polls" style={tileLink}>
            ...
            <div style={tileValue}>{leadingSeatBloc.seats} <span style={{ fontSize: 15, fontWeight: 600, color: 'rgba(255,255,255,.5)' }}>/ {MAJORITY_SEATS} to govern</span></div>
          </Link>

          <Link href="/elections/2026#polls" style={tileLink}>
            <div style={tileLabel}>Preferred PM</div>
            <div style={tileValue}>{pmLeader.name.split(' ').slice(-1)[0]} <span style={{ fontSize: 15, fontWeight: 700, color: 'rgba(255,255,255,.6)' }}>{pmLeader.pct}%</span></div>
          </Link>
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, alignItems: 'center' }}>
          <Link href="/elections/2026" style={{ display: 'inline-flex', alignItems: 'center', gap: 7, padding: '12px 22px', borderRadius: 11, background: '#36e08a', color: '#0c0e12', fontSize: 16, fontWeight: 800, fontFamily: MANROPE, textDecoration: 'none' }}>
            Explore the Election Centre <ArrowRight style={{ width: 16, height: 16 }} />
          </Link>
          <span style={{ fontSize: 14, color: 'rgba(255,255,255,.5)', fontFamily: MANROPE }}>
...
const tileLabel: React.CSSProperties = {
  fontSize: 13, fontWeight: 700, color: 'rgba(255,255,255,.55)', fontFamily: MANROPE,
  textTransform: 'uppercase', letterSpacing: '.04em', marginBottom: 8,
}
const tileValue: React.CSSProperties = {
  fontSize: 25, fontWeight: 800, color: '#fff', fontFamily: MANROPE, lineHeight: 1.1,
}

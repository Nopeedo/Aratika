...
export function GetReadyToVote() {
  return (
    // Transparent so the page-level weave shows through (one texture for the
    // whole homepage). Borders keep gentle section separation.
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 16 }}>
          ...
          <Link href="/start" style={{ textDecoration: 'none' }}>
            <div className="party-card" style={{ height: '100%', background: '#fff', border: `1px solid ${BORDER}`, borderRadius: 18, padding: '22px 22px' }}>
              ...
              <div style={{ fontSize: 19, fontWeight: 800, color: INK, fontFamily: MANROPE, marginBottom: 5 }}>3. Find what matters to you</div>
              <p style={{ fontSize: 16, fontWeight: 500, color: SECONDARY, fontFamily: MANROPE, lineHeight: 1.55, margin: '0 0 14px' }}>A 3-minute walkthrough that shows where the parties stand on your issues.</p>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: 5, fontSize: 15, fontWeight: 800, color: JADE, fontFamily: MANROPE }}>Take the walkthrough <ArrowRight style={{ width: 14, height: 14 }} /></span>
            </div>
          </Link>
        </div>
      </div>

    ...
    <section style={{ background: '#0c0e12' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '72px clamp(18px, 5vw, 36px)' }}>
        ...
        <div style={{ textAlign: 'center', maxWidth: 560, margin: '0 auto 48px' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(245,197,24,0.15)', color: '#F5C518', borderRadius: 999, padding: '5px 12px', fontSize: 14, fontWeight: 700, fontFamily: MANROPE, marginBottom: 16 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 240px), 1fr))', gap: 16, maxWidth: 640, margin: '0 auto' }}>
          ...
          <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: '24px 22px' }}>
            <div style={{ fontSize: 14, fontWeight: 700, color: '#6b7078', fontFamily: MANROPE, marginBottom: 6 }}>Free</div>
            <div style={{ fontSize: 37, fontWeight: 700, color: '#ffffff', fontFamily: 'var(--font-space-grotesk), system-ui, sans-serif', marginBottom: 20 }}>$0</div>
            ...
            <Link href="/register" style={{ display: 'block', textAlign: 'center', padding: '11px 0', borderRadius: 10, border: '1px solid rgba(255,255,255,0.12)', color: '#ffffff', fontSize: 16, fontWeight: 700, fontFamily: MANROPE, textDecoration: 'none' }}>
              Sign up free
            </Link>
          </div>
          ...
          <div style={{ background: 'linear-gradient(145deg, rgba(245,197,24,0.12), rgba(245,197,24,0.04))', border: '1px solid rgba(245,197,24,0.25)', borderRadius: 20, padding: '24px 22px', position: 'relative' }}>
            <div style={{ position: 'absolute', top: -13, left: '50%', transform: 'translateX(-50%)', background: '#F5C518', color: '#1c1605', fontSize: 13, fontWeight: 800, fontFamily: MANROPE, borderRadius: 999, padding: '4px 12px', whiteSpace: 'nowrap' }}>
              14-day free trial
            </div>
            <div style={{ fontSize: 14, fontWeight: 700, color: '#F5C518', fontFamily: MANROPE, marginBottom: 6 }}>Premium</div>
            ...
            <Link href="/register?plan=premium" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, padding: '11px 0', borderRadius: 10, background: '#F5C518', color: '#1c1605', fontSize: 16, fontWeight: 800, fontFamily: MANROPE, textDecoration: 'none' }}>

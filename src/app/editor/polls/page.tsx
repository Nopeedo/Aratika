 ...
 * are entered manually (Politika reports what pollsters publish) and go live on
  ...
  return (
    <div style={WOVEN_PAGE}>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '28px clamp(18px, 5vw, 36px) 64px' }}>
        {!user ? (
          <Gate title="Sign in required" body="Entering polls is for the Politika editorial team.">

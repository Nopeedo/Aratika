...
function page(heading: string, message: string, ok: boolean) {
  const html = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${heading} — Politika</title></head>
<body style="margin:0;background:#f4f2ec;font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;color:#2A1206">
  <div style="max-width:440px;margin:0 auto;padding:64px 24px;text-align:center">
    ...
    <a href="https://politika.nz" style="display:inline-block;background:#1F8A4C;color:#fff;font-weight:800;font-size:14px;padding:11px 20px;border-radius:11px;text-decoration:none">Back to Politika</a>
  </div>
</body></html>`

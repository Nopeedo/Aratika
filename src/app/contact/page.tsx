...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with Politika, or report a correction. Accuracy matters to us.',
}
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: '30px clamp(18px, 5vw, 36px) 64px', display: 'flex', flexDirection: 'column', gap: 22 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(280px, 100%), 1fr))', gap: 14 }}>
          <div style={{ background: '#fff', border: `1px solid ${BORDER}`, borderRadius: 16, padding: '22px 24px' }}>
            ...
            <a href={`mailto:${EMAIL}?subject=Politika%20enquiry`} style={btn(true)}>Email us <ArrowUpRight style={ic} /></a>
          </div>
        ...
        <p style={{ fontSize: 12.5, color: TERTIARY, fontFamily: MANROPE, lineHeight: 1.6, margin: 0 }}>
          Politika is an independent platform and can’t help with official or urgent matters. To enrol, vote, or contact an

/**
 * /about — who Politika is, our principles, and our official data sources
...
export const metadata: Metadata = {
  title: 'About Politika',
  description: 'Politika is an independent, non-partisan platform making New Zealand politics clear, credible and accessible.',
}
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '36px clamp(18px, 5vw, 36px) 64px', display: 'flex', flexDirection: 'column', gap: 36 }}>
        ...
        <section id="sources" style={{ scrollMarginTop: 80 }}>
          ...
          <p style={{ fontSize: 14, color: SECONDARY, fontFamily: MANROPE, margin: '0 0 16px', lineHeight: 1.6 }}>
            Credibility is the whole point. Everything on Politika traces back to official, public sources:
          </p>
        ...
        <section style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 16, padding: '20px 22px' }}>
          ...
          <p style={{ fontSize: 13.5, color: '#33373f', fontFamily: MANROPE, lineHeight: 1.7, margin: 0 }}>
            Politika is not affiliated with the Government, Parliament, the Electoral Commission, or any political party. Spotted

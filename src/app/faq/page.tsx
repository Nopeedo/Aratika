...
export const metadata: Metadata = {
  title: 'Help & FAQ',
  description: 'How Politika stays non-partisan, where our information comes from, how we’re funded, and how to get started.',
}
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: '30px clamp(18px, 5vw, 36px) 64px', display: 'flex', flexDirection: 'column', gap: 34 }}>
        ...
        <Section label="Trust & independence">
          ...
          <QA q="What if you get something wrong?">
            Tell us and we’ll fix it fast. Accuracy is what makes Politika worth using, so we check every report against the
        ...
        <p style={{ fontSize: 12.5, color: TERTIARY, fontFamily: MANROPE, lineHeight: 1.6, margin: 0 }}>
          Politika is an independent platform and can’t help with official or urgent matters. To enrol or vote, use the
          official service at{' '}

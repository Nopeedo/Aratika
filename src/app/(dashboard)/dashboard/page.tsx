    ...
    <div style={{ ...WOVEN_PAGE, minHeight: 'calc(100vh - 64px)' }}>
      <div style={{ borderBottom: `1px solid ${BORDER}` }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', padding: '40px clamp(16px, 4vw, 36px) 32px' }}>
          ...
          <p style={{ fontSize: 15, color: SECONDARY, fontFamily: MANROPE, margin: 0 }}>
            Welcome to your Politika dashboard. Signed in as {user.email}.
          </p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1080, margin: '0 auto', padding: '32px clamp(16px, 4vw, 36px) 64px' }}>
        ...
        <div style={{ marginTop: 28, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          ...
          <Link href="/policies" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '10px 18px', borderRadius: 10, background: '#fff', border: `1px solid ${BORDER}`, color: INK, fontSize: 13.5, fontWeight: 700, fontFamily: MANROPE, textDecoration: 'none' }}>
